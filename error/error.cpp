...
bool util::error::header = true; // initializing
char util::error::ErrorInfo[];
char util::error::ErrorMsg[];
static util::error _error;
	...
	const char *check_args, ...)
{
  ...
  //////////////////////////////////////////////////////////////////////////////
	...
	if(check_args == NULL) { //va_list msgUserArgs is empty
		fprintf(stderr, "%s\n", ErrorInfo);
	}
...
void
util::error::set_header(bool header)
{
	error::header = header;
}

void
util::error::show_header(const char *type)
{
	//////////////////////////////////////////////////////////////////////////////
	// time information
	//////////////////////////////////////////////////////////////////////////////
